        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                the orchestration layer for private ai inference. household first. global mesh when needed.
                <br />
            ...
            <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
              {[
                {
                  href: 'https://x.com/teepin',
                  icon: <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />,
                  color: '#00f0ff',
                  disabled: false,
                },
                {
                  href: 'https://discord.gg/599VUgWYwk',
                ...
                <a
                  ...
                  title={social.disabled ? 'coming soon' : undefined}
                  style={{
                    color: '#a0a0b5',
                    ...
                    opacity: social.disabled ? 0.35 : 1,
                    pointerEvents: social.disabled ? 'none' : 'auto',
                    cursor: social.disabled ? 'not-allowed' : 'pointer',
                  }}
                  onMouseEnter={(e) => {
                    if (social.disabled) return;
